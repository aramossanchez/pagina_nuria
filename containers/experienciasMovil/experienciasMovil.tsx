...
export default function ExperienciasMovilContainer() {
  ...
  return (
    <article className={style.component_container}>
      ...
      <ExperienciasMovilSliderComponent experiencias={experienciasProyectos} introduccion='Gracias a los casi 5 años de experiencia profesional he podido dirigir grandes proyectos. Proyectos tanto a nivel nacional como a nivel local. Entre ellos, destaco los siguientes:' />
